            ...
            <React.Fragment>
                ...
                <Tabs defaultActiveKey='details' id='detailstab'>
                    ...
                    <Tab eventKey="attachments" title="Attachments">
                        {
                            this.state.currentData.id === 0 ? <p>You shoud save the new Contract before adding attachments</p> :
                                <Attachment parentItem={this.state.currentData.externalId} uploadedBy={this.context!.profile.name} />
                        }
                    </Tab>
                </Tabs>
            </React.Fragment>
