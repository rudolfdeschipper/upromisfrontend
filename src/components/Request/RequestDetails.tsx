...
class RequestDetails extends React.Component<RouteComponentProps<{ id?: string }>, IState> {
        ...
        const toSave: ISaveMessage<IRequestData> =
        {
            ...
            dataSubject:
            {
                ...
                // don't forget to take the sublists as well:
                                    teamInfo: this.state.currentData.teamInfo                             },
            subaction: subaction,
            additionalData: []
        };
    ...
    render() {
        return (
            <React.Fragment>
                <Link to={"/Request"} className="w3-button w3-light-grey w3-round" title="Back to list">
                ...
                <Tabs defaultActiveKey='details' id='detailstab'>
                    ...
                    <Tab eventKey="attachments" title="Attachments">
                        {
                            this.state.id === -1 ? <p>You shoud save the new Request before adding attachments</p> :
