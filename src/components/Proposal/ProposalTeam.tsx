...
import { IProposalData, ITeam } from './ProposalTypes';
        ...
        return (
            <div>
                ...
                <Modal isOpen={this.state.modalEditIsOpen} >
                    ...
                    <ModalBody>
                        <ProposalTeamForm buttonText="Save" currentData={this.state.currentTeamRecord as ITeam} updateValues={this.updateTeamLine} 
                ...
                <Modal isOpen={this.state.modalAddIsOpen} >
                    ...
                    <ModalBody>
                        <ProposalTeamForm buttonText="Add" currentData={this.state.currentTeamRecord as ITeam} updateValues={this.addTeamLine} 
                            memberTypevalues = {this.state.memberTypevalues} 
                        />
                    </ModalBody>
                </Modal>
                <Modal isOpen={this.state.modalDeleteIsOpen} >
                    ...
                    <ModalBody>
                        <ProposalTeamForm buttonText="Delete" currentData={this.state.currentTeamRecord as ITeam} updateValues={this.deleteTeamLine} 
                            memberTypevalues = {this.state.memberTypevalues} 
                        />
                    </ModalBody>
                </Modal>
