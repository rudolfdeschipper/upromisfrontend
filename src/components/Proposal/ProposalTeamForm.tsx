...
interface IProps {
    currentData: ITeam;
        ...
        buttonText: string;
    updateValues:  (values: ITeam) => void;
}
...
class ProposalTeamForm extends React.Component<IProps, IState> {
            ...
            >
                <Form className="w3-container" mode="themed">
                    <Input name='id' label='ID' disabled
                     />
                    <Input name='externalId' label='ExternalID' disabled
                     />
                    <Input name='teammemberID' label='TeammemberID' disabled
                     />
...
export default ProposalTeamForm;
