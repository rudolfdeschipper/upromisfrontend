...
import { IPayment } from './ProposalTypes';
import ProposalTeam from './ProposalTeam';
import { ITeam } from './ProposalTypes';
...
class ProposalDetails extends React.Component<RouteComponentProps<{ id?: string }>, IState> {
    ...
    render() {
        return (
            <React.Fragment>
                <Link to={"/Proposal"} className="w3-button w3-light-grey w3-round" title="Back to list">
                ...
                <Tabs defaultActiveKey='details' id='detailstab'>
                    ...
                    <Tab eventKey="attachments" title="Attachments">
                        {
                            this.state.id === -1 ? <p>You shoud save the new Proposal before adding attachments</p> :
