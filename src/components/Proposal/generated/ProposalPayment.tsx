...
**             ------ IMPORTANT ------
<<<<<<< HEAD
** This file was generated by ZeroCode2 on 28/Dec/2020 15:38:12
=======
...
import { IProposalData, IPayments } from './ProposalTypes';
        ...
        return (
            <div>
                ...
                <Modal isOpen={this.state.modalEditIsOpen} >
                    ...
                    <ModalBody>
                        <ProposalPaymentForm buttonText="Save" currentData={this.state.currentPaymentRecord as IPayments} updateValues={this.updatePaymentLine} 
                ...
                <Modal isOpen={this.state.modalAddIsOpen} >
                    ...
                    <ModalBody>
                        <ProposalPaymentForm buttonText="Add" currentData={this.state.currentPaymentRecord as IPayments} updateValues={this.addPaymentLine} 
                        />
                    </ModalBody>
                </Modal>
                <Modal isOpen={this.state.modalDeleteIsOpen} >
                    ...
                    <ModalBody>
                        <ProposalPaymentForm buttonText="Delete" currentData={this.state.currentPaymentRecord as IPayments} updateValues={this.deletePaymentLine} 
                        />
                    </ModalBody>
                </Modal>
            </div>
